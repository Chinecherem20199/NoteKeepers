...
public class NoteCreationTest {
    ...
    @Rule
    public ActivityTestRule<NoteListActivity> mNoteListActivityActivity = new ActivityTestRule<>(NoteListActivity.class);
...
//        fabNewNote.perform(click());
        ...
        onView(withId(R.id.spinner_cources)).check(matches(withSpinnerText(
